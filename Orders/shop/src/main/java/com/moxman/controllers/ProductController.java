...
public class ProductController {
	...
	public String getUpdateProduct(@PathVariable("pid") int pid, Model m) {

		Product product = productDAOImpl.getProductbyID(pid);
		...
		m.addAttribute("catlist", this.getCatList());
		m.addAttribute("subcatdetail", this.getSubCatList());
		return "editproduct";
	}

	@RequestMapping(value = "updateprod", method = RequestMethod.POST)
	public String updateCategory(@ModelAttribute("editproduct") Product product, Model m) {
	...
	@RequestMapping("")
	public String productdesc(Model m) {
		List<?> list=productDAOImpl.getAllProduct();
	//	m.addAttribute();
		return "";
	}
