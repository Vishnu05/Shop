...
function update_amounts() {
    ...
    $('#cart > tbody  > tr').each(function () {
        ...
        if(uname >= 1){
            ...
            $(".status").html("<font color=red>Quantity should be <b></b> greater than Three.</font>");
					...
					<tbody>
					 ...
					 <c:forEach items="${cartitems}" var="cartitem">
						<tr>
							...
							<td> <h4>   <img
								src="<c:url value="/images/${cartitem.proid }.jpg"/>"
								style="height: 60px; width: 135px" alt="Error on loading images" /> </h4></td>
							<td data-th="Price"><span id="price" class="price">${cartitem.price}</span></td>
							<td data-th="Quantity">
							<input type="number" name="qty" id="quty">
