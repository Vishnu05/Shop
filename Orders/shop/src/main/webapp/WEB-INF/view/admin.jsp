		...
		<div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    ...
                    <h3 align="right" class="panel-title"><span class="glyphicon glyphicon-log-out"></span><a href="perform_logout">Logout</a></h3>
                    <h3 align="right" class="panel-title"><span class=" glyphicon glyphicon-log-in"></span><a href="user">Register</a></h3>
   					<h3 align="right" class="panel-title"><span class=" glyphicon "></span><a href="orders">Orders</a></h3>
                    <h3 align="right" class="panel-title"><a href="login">login</a></h3>
                    <a href="cart">My Cart</a>
     		 <h3 align="right" class="panel-title"><span class=" "></span><a href="productdisplay">Products</a></h3>
                ...
                <div class="panel-body">
                   <div class="row">
                        <div class="col-md-12">
                          <!-- dblue -->
                          <a href="newproduct" class="btn btn-dblue btn-lg" role="button"><span class="glyphicon glyphicon-user glyphsize"></span> <br />Add <span class="glyphicon glyphicon-plus green"></span><br />Product</a>
                          <a href="viewproduct" class="btn btn-dblue btn-lg" role="button"><span class="glyphicon glyphicon-user glyphsize"></span> <br />Edit <span class="glyphicon glyphicon-edit yellow"></span><br />Product</a>
                          <a href="viewproduct" class="btn btn-dblue btn-lg" role="button"><span class="glyphicon glyphicon-user glyphsize"></span> <br />Delete <span class="glyphicon glyphicon-minus red"></span><br />Product</a>
                          <a href="viewproduct" class="btn btn-dblue btn-lg" role="button"><span class="glyphicon glyphicon-user glyphsize"></span> <br />View<br />Products <span class="glyphicon glyphicon-envelope"></span></a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          <!-- dred -->
                          <a href="category" class="btn btn-dred btn-lg" role="button"><span class="glyphicon glyphicon-list glyphsize"></span> <br/>Add <span class="glyphicon glyphicon-plus green"></span><br /> Category</a>
                          <a href="viewcategory" class="btn btn-dred btn-lg" role="button"><span class="glyphicon glyphicon-list glyphsize"></span> <br />Edit <span class="glyphicon glyphicon-edit yellow"></span><br />Category</a>
                          <a href="viewcategory" class="btn btn-dred btn-lg" role="button"><span class="glyphicon glyphicon-list glyphsize"></span> <br/>Delete <span class="glyphicon glyphicon-minus red"></span><br /> Category</a>
                          <a href="viewcategory" class="btn btn-dred btn-lg" role="button"><span class="glyphicon glyphicon-list glyphsize"></span> <br/>View <span class="glyphicon glyphicon-eye-open"></span><br />Category</a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          <!-- dgreen -->
                        <a href="subcategory" class="btn btn-dgreen btn-lg" role="button"><span class="glyphicon glyphicon-list-alt glyphsize green"></span> <br/>Add<br />SubCategory</a>
                        <a href="subcategory" class="btn btn-dgreen btn-lg" role="button"><span class="glyphicon glyphicon-list-alt glyphsize green"></span> <br/>Edit<br />SubCategory</a>
                        <a href="subcategory" class="btn btn-dgreen btn-lg" role="button"><span class="glyphicon glyphicon-list-alt glyphsize green"></span> <br/>Delete<br />SubCategory</a>
                        <a href="subcategory" class="btn btn-dgreen btn-lg" role="button"><span class="glyphicon glyphicon-list-alt glyphsize green"></span> <br/>View<br />SubCategory</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          ...
                          <a href="adminorders" class="btn btn-purple btn-lg" role="button"><span class="glyphicon glyphicon-shopping-cart glyphsize black"></span> <br/>View<br />Orders</a>
                            <a href="getorders?fromdate${fromdate}&todate${todate}" class="btn btn-purple btn-lg" role="button"><span class="glyphicon glyphicon-shopping-cart glyphsize black"></span> <br/><br />Get Orders</a>
                        </div>
                    </div>
