            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    ...
                    <h3 align="right" class="panel-title"><span class=" glyphicon glyphicon-log-in"></span><a href="user">Register</a></h3>
   					<h3 align="right" class="panel-title"><span class=" glyphicon "></span><a href="check_order">Orders</a></h3>
                ...
                <div class="panel-body">
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          <!-- purple -->
                          <a href="#" class="btn btn-purple btn-lg" role="button"><span class="glyphicon glyphicon-shopping-cart glyphsize black"></span> <br/>View<br />Orders</a>
                        </div>
                    </div>
