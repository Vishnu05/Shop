			...
			<tr>
				...
				<c:forEach items="${proddetails}" var="product">
					<tr>
						...
						<td> <img src="<c:url value="/images/${product.pid }.jpg"/>" style="height:200px; width:60%" alt="Error on loading images"/></td>
						<td><div ><a href="cart" class="btn btn-info">Add To Cart</a></div>
					</tr>
				</c:forEach>
