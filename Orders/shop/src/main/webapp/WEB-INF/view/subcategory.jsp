...
<body>
	...
	<c:if test="${flag}">
		<form:form action="UpdateSubCategory" modelAttribute="subcategory"
			method="post">
			<table align="center" cellspacing="2">

				<tr>
					<td><form:input type="hidden" path="subcatid"
							value="${subcategory.subcatid}" /></td>
				</tr>
				...
				<tr>
					...
					<td><form:input type="text" path="subcatname"
							value="${subcategory.subcatname}" /></td>
				</tr>
				...
				<tr>
					...
					<td><form:input type="text" path="subcatdescription"
							value="${subcategory.subcatdescription}" /></td>
				</tr>
				...
				<tr>
					...
					<td><form:select path="catid" required="true">
							<form:option value="${subcategory.catid}"
								label="------Select----" />
		...
		<form:form action="Addsubcategory" modelAttribute="subcategory">
			<table align="center" cellspacing="2">
				...
				<tr>
					<td colspan="2">
						<center>
							<input type="submit" value="ADD A NEW SUBCATEGORY" />
						</center>
					</td>
				</tr>
...
<br><br>	<table cellspacing="2" align="center" border="5" class="table table-striped" >
		...
		<c:forEach items="${subcatdetail}" var="subcategory">
			<tr bgcolor="#00ff99">
				...
				<td><a
					href="<c:url value="updateSubcategory/${subcategory.subcatid}"/>">Update</a>
					<a
					href="<c:url value="deletesubcategory/${subcategory.subcatid}"/>">Delete</a>
				</td>
			</tr>
		</c:forEach>
	</table>
