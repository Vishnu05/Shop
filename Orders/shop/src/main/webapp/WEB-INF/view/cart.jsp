...
<c:if test="${n==0 }">
<div>
<p align="center">Your cart is empty Go back and Purchase <a href="productdisplay">Products</a> </p>
</div>
</c:if>
...
<script>
function myFunction() {
    document.getElementById("coup").innerHTML = "Hello World";
}
</script>
		<c:if test="${n!=0}">
			<div>
...
<!--  				<button onclick="myFunction()">Click me</button> -->
					<input type="text" id="coup" placeholder="Enter The coupons"><input
						type="submit" value="Coupon ID" class="btn btn-success">
				</form>
			</div>
		</c:if>
	</div></c:if>
